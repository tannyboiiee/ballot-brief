...
export const MODIFIER_CODES = new Set(["149", "34", "120B", "511"]);

export const UAPA_SECTIONS = new Set(["10", "13", "17", "18", "18B", "40"]);
...
export function classifyOffenseType(section, otherActsText = "") {
...
export function classifyCase(rawSections, otherActs = "") {
